...
app.get('/api/totp/groups', authenticateToken, (req, res) => {
    db.all(
...
app.put('/api/totp/group/rename', authenticateToken, (req, res) => {
...
app.delete('/api/totp/group/:name', authenticateToken, (req, res) => {
...
app.put('/api/totp/:id', authenticateToken, (req, res) => {
...
app.get('/api/totp/export', authenticateToken, (req, res) => {
    db.all(
